...
__kernel void generateRays(
	...
	initialRays[pos.x + pos.y * get_global_size( 1 )] = initialRay;
}
...
__kernel void pathTracing(
	...
	__global float* eyeIn, __global float4* initialRays,
	...
	float4 eye = (float4)( eyeIn[0], eyeIn[1], eyeIn[2], 0.0f );
	float4 initialRay = initialRays[pos.x + pos.y * get_global_size( 1 )];
