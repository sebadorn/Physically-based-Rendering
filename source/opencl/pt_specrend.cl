...
*/
constant float cie_colour_match[81][3] = {
...
/*                          SPECTRUM_TO_XYZ
    ...
    arguments which respect the identity:
            x + y + z = 1.
*/
void spectrum_to_xyz( float wavelength, float* x, float* y, float* z ) {
	int index;
	float me, X, Y, Z, XYZ;

	index = (int) ( ( wavelength - 380.0f ) / 5.0f );
...
/*  The x, y, and Z and RGB values for black body spectra
    from 1000 to 10000 degrees kelvin.
